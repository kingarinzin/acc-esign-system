...
export default function AccOagReferralPage() {
  ...
  const [isEditingStatus, setIsEditingStatus] = useState(false);    //for edit drop down. 
  ...
  // 👇 YOUR ADDED BLOCK HERE
//if (userRole === "OAG_USER") {
  //return (
  ...
  <div className="flex items-center gap-3">
    ...
    {!isEditingStatus ? (
      ...
      <select
        ...
        onChange={(e) => {
          console.log(e.target.value); // later API
          setIsEditingStatus(false);
        }}
      >
        <option>Pending</option>
        <option>Under Review</option>
        <option>Under Prosecution</option>
        <option>Trial</option>
      </select>
    )}
